			...
			SELECT *
				FROM(SELECT 
					...
					CASE
						...
						WHEN job_name ILIKE '%data%' AND job_name ILIKE '%analyst%'= true THEN 'Data Analyst'				WHEN job_name ILIKE '%data%' AND job_name ILIKE '%analytics%'= true THEN 'Data Analyst'
